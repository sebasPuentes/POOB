...
public class POOBkemon implements Serializable{
    ...
    /**
     * Serializa el juego en un archivo.
     */
    public void defaultGame() {
        ...
        blastoise1.setMovements(new Movement[]{hidrobomba, lanzallamas, pulsoDragon, puñoLucha});
    ...
    /**
     * Cambia el pokemon activo del entrenador actual.
     * @param pokemonName
     */
    ...
    /**
     * Verifica si la máquina ha jugado.
     */
    ...
    /**
     * Avanza el turno al siguiente entrenador.
     */
    ...
    /**
     * Reinicia los turnos de la batalla.
     */
    ...
    /**
     * Reinicia el juego, eliminando todos los entrenadores y Pokémon.
     */
    ...
    /**
     * Agrega un nuevo entrenador al juego.
     * @param name El nombre del entrenador.
     * @param color El color del entrenador.
     * @throws POOBkemonException Si el nombre ya existe o si hay un error al crear el entrenador.
     */
    ...
    /**
     * Inicializa el Pokémon de un entrenador.
     * @param trainer El nombre del entrenador.
     * @param pokemon El nombre del Pokémon.
     * @throws POOBkemonException Si el Pokémon no existe o si hay un error al inicializarlo.
     */
    ...
    /**
     * Obtiene un trainer por su nombre.
     * @param name
     * @return
     */
    ...
    /**
     * Obtiene la Pokédex.
     * @return TreeMap<String, Pokemon> con los Pokémon.
     */
    ...
    /**
     * Obtiene el mapa de movimientos por defecto.
     * @return TreeMap<String, Movement> con los movimientos.
     */
    ...
    /**
     * Obtiene el mapa de objetos por defecto.
     * @return HashMap<String, Item> con los objetos.
     */
    ...
    /**
     * Obtiene el mapa de entrenadores.
     * @return HashMap<String, Trainer> con los entrenadores.
     */
     ...
     * @return El nombre del ganador o null si no hay ganador.
     */

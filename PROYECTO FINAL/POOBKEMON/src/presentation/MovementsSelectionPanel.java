...
public class MovementsSelectionPanel extends JPanel {
    ...
    private void loadBackgroundImage() {
        try {
            String[] possiblePaths = {
                "src/resources/escenas/fondo_movimientos.png",
                "src/resources/escenas/gimnasio.png",
    ...
    private void loadPokemonImage(String pokemonName, JLabel label) {
        String[] paths = {
            "src/resources/ataques/" + pokemonName + ".gif",
            "src/resources/ataques/" + pokemonName + ".png",
            "src/resources/pokemon/" + pokemonName + ".gif",
            "src/resources/pokemon/" + pokemonName + ".png"
        };

 ...
 * @author Julian Lopez, Juan Puentes
...
public class TrainersPanel extends JPanel {
    ...
    private void loadBackgroundImage() {
        String[] possiblePaths = {
                "src/resources/escenas/seleccionPersonajes.png",
                "src/resources/escenas/seleccionPersonajes.png",
                "src/resources/escenas/trainer_bg.png",
                "src/resources/escenas/trainer_bg.png"
        };
    ...
    private void prepareElements() {
        ...
        trainerImageLabel.setBackground(new Color(255, 255, 255, 100));
    ...
    //==========================================================================
    // 6. GESTIÓN DE EVENTOS Y ACCIONES
    //==========================================================================
    /**
    ...
    //==========================================================================
    // 7. LÓGICA DE SELECCIÓN DE ENTRENADORES
    //==========================================================================
    ...
    /**
     * Checks if both trainer selections are complete
     * @return true if both trainers have been selected
     */
    public boolean isSelectionComplete() {
        return !isSelectingPlayer1 && !player1Name.isEmpty() && !player2Name.isEmpty();
    }
    ...
    private void updateTrainerDisplay() {
        try {
            ...
            File gifFile = new File("src/resources/entrenadores/" + currentSprite + ".gif");

            if (gifFile.exists() && gifFile.isFile()) {
                // Cargar el GIF como un ImageIcon
                ImageIcon gifIcon = new ImageIcon(gifFile.getAbsolutePath());
                trainerImageLabel.setIcon(gifIcon);
                trainerImageLabel.setText("");
            } else {
                // Si no se encuentra el archivo, mostrar mensaje
                trainerImageLabel.setIcon(null);
                trainerImageLabel.setText("Sprite no encontrado: " + currentSprite);
                System.out.println("No se encontró el archivo GIF: " + gifFile.getAbsolutePath());
            }
        } catch (Exception e) {

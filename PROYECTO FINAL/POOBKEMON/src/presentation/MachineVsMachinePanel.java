...
public class MachineVsMachinePanel extends JPanel {
    ...
    private final Color SELECTED_COLOR_1 = new Color(30, 144, 255, 180);
    private final Color SELECTED_COLOR_2 = new Color(220, 20, 60, 180);
    ...
    private void loadBackgroundImage() {
        String imagePath = "src/resources/escenas/seleccionMaquinas.png";
        try {
    ...
    private JPanel createTrainerTypeCard(String trainerType, int panelNum) {
        ...
        try {
            String imagePath = "src/resources/entrenadores/" + trainerType.toLowerCase() + ".png";
